...
box_score_data = st.session_state.get("box_score_data")
ar_data        = st.session_state.get("ar_data")
lto_data       = st.session_state.get("lto_data")
...
if rr_data and st.session_state.get("rr_property_id") != property_id:
    rr_data = None
if budget_data and st.session_state.get("budget_property_id") != property_id:
    budget_data = None
if box_score_data and st.session_state.get("box_score_data_property_id") != property_id:
    box_score_data = None
if ar_data and st.session_state.get("ar_data_property_id") != property_id:
    ar_data = None
if lto_data and st.session_state.get("lto_data_property_id") != property_id:
    lto_data = None
...
if active == "Overview":
    ...
    render_fin(t12_data, rr_data, budget_data)
    ...
    render_rr(rr_data, box_score_data=box_score_data,
              ar_data=ar_data, lto_data=lto_data)
